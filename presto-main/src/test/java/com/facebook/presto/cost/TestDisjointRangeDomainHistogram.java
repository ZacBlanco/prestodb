...
{
    /**
     * A uniform base with 2 ranges that are within the
     */
    @Test
    public void testBasicDisjointRanges()
    {
        ...
        assertEquals(87.5, constrained.inverseCumulativeProbability(0.75).getValue());
        assertEquals(0.0, constrained.inverseCumulativeProbability(0.0).getValue());
        assertEquals(100, constrained.inverseCumulativeProbability(1.0).getValue());
        assertEquals(25, constrained.inverseCumulativeProbability(0.5).getValue());
    }
