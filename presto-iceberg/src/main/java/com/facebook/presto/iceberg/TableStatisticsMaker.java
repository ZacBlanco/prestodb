...
public class TableStatisticsMaker
{
    ...
    public static TableStatistics getTableStatistics(ConnectorSession session, TypeManager typeManager, Constraint<ColumnHandle> constraint, IcebergTableHandle tableHandle, Table icebergTable, List<IcebergColumnHandle> columns)
    {
        return new TableStatisticsMaker(icebergTable, session, typeManager).makeTableStatistics(tableHandle, constraint, columns);
    }

    private TableStatistics makeTableStatistics(IcebergTableHandle tableHandle, Constraint<ColumnHandle> constraint, List<IcebergColumnHandle> selectedColumns)
    {
