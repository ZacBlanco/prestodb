...
* Add new session property :ref:`admin/properties-session:\`\`join_prefilter_build_side_with_complex_probe_side`` (default false) to extend join prefilter optimization to support complex probe-side patterns including UNION ALL, cross join, unnest, and aggregation. `#27598 <https://github.com/prestodb/presto/pull/27598>`_
